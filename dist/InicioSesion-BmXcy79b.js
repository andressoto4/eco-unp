...
import React__default, { useRef, useState, useCallback, useEffect, useReducer, useContext, useMemo, cloneElement, isValidElement, forwardRef, createElement, Component } from 'react';
import { v as _objectWithoutPropertiesLoose$7, u as useBootstrapPrefix, j as jsxRuntimeExports, c as classNames, w as divWithClassName, e as triggerBrowserReflow, T as TransitionWrapper, t as transitionEndListener, b as ENTERING, d as ENTERED, P as PropTypes, f as FormCheckInput, x as useMergedRefs, y as context$2, z as map, A as forEach, n as Container, R as Row, C as Col, o as Card, B as CardHeader, D as CardTitle, p as CardBody, G as GenIcon, _ as __awaiter, m as __generator, H as requireReactIs, I as getDefaultExportFromCjs, i as FormGroup, k as FormLabel, l as FormControl, J as FaXTwitter, K as FaInstagram, L as FaFacebook, M as FaYoutube, N as FaHeadphones, O as FaPhoneFlip } from './tslib.es6-D-vgAbys.js';
...
function useUncontrolled(props, config) {
  return Object.keys(config).reduce(function (result, fieldName) {
    ...
    var _ref = result,
        ...
        rest = _objectWithoutPropertiesLoose$7(_ref, [defaultKey(fieldName), fieldName].map(_toPropertyKey));
...
const Button$1 = /*#__PURE__*/React.forwardRef((_ref, ref) => {
  let {
    ...
    props = _objectWithoutPropertiesLoose$6(_ref, _excluded$5);
  const [buttonProps, {
    tagName: Component
...
function useTabPanel(_ref) {
  ...
  const {
    ...
    rest = _objectWithoutPropertiesLoose$2(context, _excluded2);
...
(_ref2, ref) => {
  let {
    ...
    props = _objectWithoutPropertiesLoose$2(_ref2, _excluded3);
  const [tabPanelProps, {
    isActive,
    onEnter,
    onEntering,
...
var handleEnviarClick = function () {
    alert('Estamos trabajando... paciencia :)');
};
var CardForm = function (_a) {
    var children = _a.children, method = _a.method, titulo = _a.titulo;
    return (React__default.createElement(Container, { className: "py-5" },
        React__default.createElement(Row, { className: "justify-content-center" },
            React__default.createElement(Col, { xl: 10, md: 11, xs: 12 },
                React__default.createElement(Card, { style: borderUnpStyle, className: "border-0 rounded-3 shadow" },
                    React__default.createElement(CardHeader, { style: bgUnpStyle, className: "text-center text-light rounded-3 rounded-bottom-0 py-4" },
                        React__default.createElement(CardTitle, { className: "px-xs-0 px-md-1 pd-lg-2" },
                            React__default.createElement("h4", null, titulo))),
                    React__default.createElement(CardBody, { className: "px-4" },
                        React__default.createElement("form", { method: method },
                            children,
                            React__default.createElement(Row, { className: "d-flex justify-content-end me-0" },
                                React__default.createElement(Button, { style: btnSendStyle, onClick: handleEnviarClick }, "Enviar")))))))));
};
...
var SubtituloForm = function (_a) {
    ...
    return (React__default.createElement(Row, { className: 'mb-1 mt-3' },
        React__default.createElement(Col, { className: "col-auto pe-1" },
            React__default.createElement(Icon, { style: iconStyle })),
        React__default.createElement(Col, { className: "ps-1 col-auto align-self-center" },
            React__default.createElement("p", { style: subtituloStyle }, subtitulo))));
};
...
var TabVentana = function (_a) {
    var eventKey = _a.eventKey, title = _a.title, children = _a.children;
    return (React__default.createElement(Tab$1, { eventKey: eventKey, title: title }, children));
};
...
var MenuLateral = function (_a) {
    ...
    return (React__default.createElement("div", { className: "container-fluid ".concat(isOpen ? "menu-open" : "") },
        React__default.createElement("div", { className: sidebarClass },
            React__default.createElement("div", { className: "logo_details" },
                React__default.createElement("img", { src: "/logo-unp-gris.png", alt: "Logo", className: "icon logo-image" }),
                React__default.createElement("div", { className: "logo-name" }, "ECOSISTEMA UNP"),
                isOpen ? React__default.createElement(BiMenuAltRight, { className: "bx bx-menu i", id: "btn", onClick: onToggle }) : React__default.createElement(BiMenu, { className: "bx bx-menu i", id: "btn", onClick: onToggle })),
            React__default.createElement("ul", { className: "nav-list-panel" },
                React__default.createElement("li", null,
                    React__default.createElement("a", { href: "" },
                        React__default.createElement(BiHome, { className: 'bx bx-home i2' }),
                        React__default.createElement("span", { className: "link_name" }, "Inicio")),
                    React__default.createElement("span", { className: "tooltip" }, "Inicio")),
                React__default.createElement("li", null,
                    React__default.createElement("a", { href: "" },
                        React__default.createElement(BiMapPin, { className: 'bx bx-map-pin i2' }),
                        React__default.createElement("span", { className: "link_name" }, "Mapa del proceso")),
                    React__default.createElement("span", { className: "tooltip" }, "Mapa del proceso")),
                React__default.createElement("li", null,
                    React__default.createElement("a", { href: "" },
                        React__default.createElement(BiBookAlt, { className: 'bx bx-book-alt i2' }),
                        React__default.createElement("span", { className: "link_name" }, "Manuales de usuario")),
                    React__default.createElement("span", { className: "tooltip" }, "Manual de usuario")),
                React__default.createElement("div", { style: { paddingLeft: "15px", paddingRight: "15px" } },
                    React__default.createElement("hr", { style: { borderTop: "1px solid white" } })),
                React__default.createElement("li", null,
                    React__default.createElement("a", { href: "https://www.unp.gov.co/" },
                        React__default.createElement(BiLinkAlt, { className: 'bx bx-link-alt i2' }),
                        React__default.createElement("span", { className: "link_name" }, "Portal UNP")),
                    React__default.createElement("span", { className: "tooltip" }, "Portal UNP")),
                React__default.createElement("li", null,
                    React__default.createElement("a", { href: "https://login.microsoftonline.com/common/oauth2/authorize?client_id=00000002-0000-0ff1-ce00-000000000000&redirect_uri=https%3a%2f%2foutlook.office365.com%2fowa%2f&resource=00000002-0000-0ff1-ce00-000000000000&response_mode=form_post&response_type=code+id_token&scope=openid&msafed=1&msaredir=1&client-request-id=f8488f2f-33b7-d769-3dc8-fe71d263f531&protectedtoken=true&claims=%7b%22id_token%22%3a%7b%22xms_cc%22%3a%7b%22values%22%3a%5b%22CP1%22%5d%7d%7d%7d&nonce=638372347486593361.36439678-d731-49f6-a49f-cc0594f2abb0&state=Dcs7EoAgDEVR0HE5kc8LCVkO4NBaun1T3NPdGEI4vcOL2Qkq6NAKVu7SDJByQxgm2ulRFGLbQsOltXIz3nXMmaO_V3q_kX4" },
                        React__default.createElement(BiEnvelope, { className: 'bx bx-envelope i2' }),
                        React__default.createElement("span", { className: "link_name" }, "Correo institucional")),
                    React__default.createElement("span", { className: "tooltip" }, "Correo institucional")),
                React__default.createElement("li", null,
                    React__default.createElement("a", { href: "http://intranet.unp.gov.co/" },
                        React__default.createElement(BiLogoRedux, { className: 'bx bxl-redux i2' }),
                        React__default.createElement("span", { className: "link_name" }, "Acceso directo a Intranet")),
                    React__default.createElement("span", { className: "tooltip" }, "Acceso directo a Intranet")),
                React__default.createElement("li", null,
                    React__default.createElement("a", { href: "https://mesadeservicios.unp.gov.co/HEAT/" },
                        React__default.createElement(BiErrorCircle, { className: 'bx bx-error-circle i2' }),
                        React__default.createElement("span", { className: "link_name" }, "Mesa de servicios")),
                    React__default.createElement("span", { className: "tooltip" }, "Mesa de servicios")),
                React__default.createElement("div", { style: { paddingLeft: "15px", paddingRight: "15px" } },
                    React__default.createElement("hr", { style: { borderTop: "1px solid white" } })),
                React__default.createElement("li", null,
                    React__default.createElement("a", { href: "" },
                        React__default.createElement(BiShieldPlus, { className: 'bx i2' }),
                        React__default.createElement("span", { className: "link_name" }, "Medida de emergencia")),
                    React__default.createElement("span", { className: "tooltip" }, "Medida de emergencia")),
                React__default.createElement("li", null,
                    React__default.createElement("a", { href: "" },
                        React__default.createElement(BiAnalyse, { className: 'bx i2' }),
                        React__default.createElement("span", { className: "link_name" }, "Acta de reuni\u00F3n")),
                    React__default.createElement("span", { className: "tooltip" }, "Acta de reuni\u00F3n")),
                React__default.createElement("li", null,
                    React__default.createElement("a", { href: "" },
                        React__default.createElement(BiSolidPlaneAlt, { className: 'bx i2' }),
                        React__default.createElement("span", { className: "link_name" }, "Solicitud de vi\u00E1ticos")),
                    React__default.createElement("span", { className: "tooltip" }, "Solicitud de vi\u00E1ticos"))),
            React__default.createElement("div", { className: "profile-content" },
                React__default.createElement("div", { className: "profile" },
                    React__default.createElement("a", { href: "" },
                        React__default.createElement("div", { className: "profile-detail" },
                            React__default.createElement("img", { src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQE-bIhXf-nPctSOXtLp1haeLK6dZuu-NERXQ&usqp=CAU", alt: "" }),
                            React__default.createElement("div", { className: "name-job" },
                                React__default.createElement("div", { className: "name" }, "Nombre de la Persona"),
                                React__default.createElement("div", { className: "job" }, "Rol en el EI-UNP")))),
                    React__default.createElement(BiLogOut, { className: 'icon' }))))));
};

// VentanaLienzo-V.0.1 --> desarrollador: andres.soto
var VentanaLienzo = function (_a) {
    var children = _a.children;
    var _b = React__default.useState(false), menuOpen = _b[0], setMenuOpen = _b[1];
    var handleToggle = function () {
        setMenuOpen(!menuOpen);
    };
    return (React__default.createElement(React__default.Fragment, null,
        React__default.createElement(MenuLateral, { onToggle: handleToggle, isOpen: menuOpen }),
        React__default.createElement("div", { className: "".concat(menuOpen ? 'menu-open' : '') },
            React__default.createElement("div", { className: "main-section" }, children))));
};
...
var NotificacionUsuario = function () {
    return (React__default.createElement(FaBell, { style: { width: '25px', height: '25px' } }));
};

var VentanaUsuario = function (_a) {
    var children = _a.children;
    var _b = React__default.useState(false), menuOpen = _b[0], setMenuOpen = _b[1];
    var _c = React__default.useState(undefined), key = _c[0], setKey = _c[1];
    var handleToggle = function () {
        setMenuOpen(!menuOpen);
    };
    React__default.useEffect(function () {
        if (React__default.Children.count(children) > 0) {
            var firstTab = React__default.Children.toArray(children)[0];
            setKey(firstTab.props.eventKey);
        }
    }, [children]);
    return (React__default.createElement(React__default.Fragment, null,
        React__default.createElement("div", { className: "position-absolute top-0 end-0 m-3" },
            React__default.createElement(NotificacionUsuario, null)),
        React__default.createElement(MenuLateral, { onToggle: handleToggle, isOpen: menuOpen }),
        React__default.createElement("div", { className: "".concat(menuOpen ? 'menu-open' : '') },
            React__default.createElement("div", { className: "main-section" },
                React__default.createElement(Tabs, { id: "controlled-tab-example", activeKey: key, onSelect: function (k) { return setKey(k !== null ? k : undefined); } }, React__default.Children.map(children, function (child) {
...
var IdUsuarioContext = React__default.createContext(undefined);
// Creación del contexto para el ID de la contraseña con un valor predeterminado indefinido
var IdContrasegnaContext = React__default.createContext(undefined);
...
var InicioSesionHook = function (maxAttempts, blockTime) {
    ...
    var _e = useState(false), isBlocked = _e[0], setIsBlocked = _e[1];
    var _f = useState(0), timer = _f[0], setTimer = _f[1];
    useEffect(function () {
        var interval;
    ...
    var handleSubmit = function (e, usuarioRef, contrasegnaRef, recaptchaRef) { return __awaiter(void 0, void 0, void 0, function () {
        var form, username, password, data, err_1;
        var _a, _b, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, B.promise(InicioSesionRequest(username, password, recaptchaToken), {
                            pending: "Ingresando...",
                            success: {
                                render: function (_a) {
                                    var data = _a.data;
    ...
    return { recaptchaToken: recaptchaToken, validated: validated, error: error, attempts: attempts, isBlocked: isBlocked, timer: timer, handleRecaptchaChange: handleRecaptchaChange, handleSubmit: handleSubmit };
};
...
var LogosUnp = function (_a) {
    ...
    return (React__default.createElement("div", { style: containerStyle },
        !loaded && React__default.createElement("div", { style: placeholderStyle }),
        React__default.createElement("img", { src: src, alt: alt, style: { display: loaded ? 'block' : 'none', maxWidth: '100%', maxHeight: '100%' }, onLoad: handleLoad })));
};
...
var Recaptcha = function (_a) {
    ...
    return (React__default.createElement(Col, { xl: 12, md: 9, xs: 12, className: "d-flex justify-content-center mt-4 mb-2", style: { width: '308px', height: '80px' } },
        !loaded && React__default.createElement("div", { style: { width: '305px', height: '80px', backgroundColor: 'transparent' } }),
        error && React__default.createElement("div", { style: { color: 'red' } }, error),
        React__default.createElement(RecaptchaWrapper, { key: key, ref: recaptchaRef, className: "mb-3", sitekey: sitekey, onChange: handleCaptchaChange, onLoad: handleCaptchaLoad, onErrored: handleCaptchaError })));
};

function validarInputUsuario(input) {
    var sinTildes = input.normalize("NFD").replace(/[\u0300-\u036f]/g, "").toLowerCase();
...
function RiLockPasswordFill (props) {
  return GenIcon({"tag":"svg","attr":{"viewBox":"0 0 24 24","fill":"currentColor"},"child":[{"tag":"path","attr":{"d":"M18 8H20C20.5523 8 21 8.44772 21 9V21C21 21.5523 20.5523 22 20 22H4C3.44772 22 3 21.5523 3 21V9C3 8.44772 3.44772 8 4 8H6V7C6 3.68629 8.68629 1 12 1C15.3137 1 18 3.68629 18 7V8ZM16 8V7C16 4.79086 14.2091 3 12 3C9.79086 3 8 4.79086 8 7V8H16ZM11 14V16H13V14H11ZM7 14V16H9V14H7ZM15 14V16H17V14H15Z"},"child":[]}]})(props);
}
...
var Usuario = function (_a) {
    ...
    var handleUsuarioChange = function (e) {
        ...
        var validValue = validarInputUsuario(value);
        setUsuario(validValue);
        setIsValid(validValue === value);
    };
    return (React__default.createElement(React__default.Fragment, null,
        React__default.createElement(Col, { xl: 12, md: 12, xs: 12 },
            React__default.createElement(FormGroup, { className: "mb-3", controlId: "validacionUsuario" },
                React__default.createElement(FormLabel, null, "Usuario"),
                React__default.createElement(InputGroup$1, null,
                    React__default.createElement(InputGroup$1.Text, { id: "email-icon" },
                        React__default.createElement(FaUser, null)),
                    React__default.createElement(FormControl, { className: "rounded-end", type: "text", ref: usuarioRef, value: usuario, onChange: handleUsuarioChange, onInput: handleUsuarioChange, placeholder: "nombre.apellido", pattern: "^[a-z]+\\.[a-z]+$", maxLength: 100, isInvalid: !isValid, required: true }))))));
};
var Contrasegna = function (_a) {
    ...
    return (React__default.createElement(React__default.Fragment, null,
        React__default.createElement(Col, { xl: 12, md: 12, xs: 12 },
            React__default.createElement(FormGroup, { className: "mb-3", controlId: "validacionContrasegna" },
                React__default.createElement(FormLabel, null, "Contrase\u00F1a"),
                React__default.createElement(InputGroup$1, null,
                    React__default.createElement(InputGroup$1.Text, { id: "password-icon" },
                        React__default.createElement(RiLockPasswordFill, null)),
                    React__default.createElement(FormControl, { type: showPassword ? "text" : "password", ref: contrasegnaRef, value: contrasegna, onChange: handleContrasegnaChange, placeholder: "*****************", maxLength: 100, isValid: isValid, required: true }),
                    React__default.createElement(Button, { type: "button", className: "rounded-end", variant: "secondary", onClick: function () {
                            setShowPassword(function (prev) { return !prev; });
                        } }, showPassword ? (React__default.createElement(FaRegEye, { color: "#FFF" })) : (React__default.createElement(FaRegEyeSlash, { color: "#FFF" }))),
                    React__default.createElement(FormControl.Feedback, { type: "invalid" }, "Por favor ingresa una contrasegna"))))));
};
var RedesSociales = function (_a) {
    ...
    return (React__default.createElement("a", { href: enlace, target: "_blank", rel: "noopener noreferrer", style: { textDecoration: 'none' } },
        React__default.createElement("div", { style: style, onMouseEnter: function () { return setIsHovered(true); }, onMouseLeave: function () { return setIsHovered(false); } },
            React__default.createElement(IconoRedSocial, { size: '1.2em', color: "#FFF" }),
            React__default.createElement("div", { style: tooltipStyle }, descripcion))));
};

var css_248z$1 = "@import url('https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css');\n\n/* Colores de los headers */\n.bg-unp {\n    background-color: #303d50;\n}\n\n.bg-form {\n    background-color: #365072;\n}\n\n.border-unp {\n    border-color: #365072;\n}\n\n.bg-section {\n    background-color: #f7f7f7;\n}\n\n.text-subtitle {\n    color: #303d50;\n}\n\ninput[type=\"text\"][disabled] {\n    background-color: #ffffff;\n}\n\nselect:disabled {\n    background-color: #ffffff;\n}\n\n.nav-link.active {\n    background-color: #f7f7f7 !important;\n}\n\n.nav-link {\n    border-bottom: #f7f7f7 !important;\n}\n\n.btn-next {\n    color: #f3f3f3;\n    background-color: #365072;\n    border-color: #314c70\n}\n\n.btn-next:hover {\n    color: #f3f3f3;\n    background-color: #3b5f8d;\n    border-color: #314c70\n}\n\n.btn-next:active:focus {\n    color: #f3f3f3;\n    background-color: #365072;\n    border-color: #314c70\n}\n\n.btn-send {\n    color: #f3f3f3;\n    background-color: #38a729;\n    border-color: #33a024\n}\n\n.btn-send:hover {\n    color: #f3f3f3;\n    background-color: #2d8b20;\n    border-color: #2d8b21\n}\n\n.btn-send:active:focus {\n    color: #f3f3f3;\n    background-color: #38a729;\n    border-color: #33a024\n}\n\n/* Clases para sweetalert2 */\n\n.swal2-confirm {\n    background-color: #6c757d;\n}";
styleInject(css_248z$1);

var css_248z = ".login-container {\r\n    display: flex;\r\n    align-items: center;\r\n    justify-content: center;\r\n    height: 100vh;\r\n    background-color: #E0E0E0;\r\n}\r\n\r\n.politica-datos {\r\n    margin: 0px;\r\n    color: #365072;\r\n    font-weight: 700;\r\n    font-size: 0.75em;\r\n    text-align: center;\r\n    min-width: 235px;\r\n    max-width: 235px;\r\n}\r\n\r\n.politica-datos:hover {\r\n    color: black;\r\n}";
...
var Login = function (props) {
    ...
    var usuarioRef = React__default.useRef(null);
    var contrasegnaRef = React__default.useRef(null);
    var recaptchaRef = React__default.useRef(null);
    ...
    var _a = InicioSesionHook(maxAttempts, blockTime), validated = _a.validated, error = _a.error, isBlocked = _a.isBlocked, timer = _a.timer, handleRecaptchaChange = _a.handleRecaptchaChange, handleSubmit = _a.handleSubmit;
    // ------ > Renderizado
    return (
    // Div que permite al login a ubicarse en el centro
    React__default.createElement("div", { className: "login-container" },
        React__default.createElement(Container, { style: { maxWidth: "720px" } },
            React__default.createElement(Row, { className: "justify-content-md-center border-0 rounded shadow" },
                React__default.createElement(Col, { md: 6, className: "bg-form align-content-center px-5 rounded-start" },
                    React__default.createElement(Row, { className: "justify-content-md-center" },
                        React__default.createElement("h2", { className: "text-center text-white" }, "Ecosistema de Informaci\u00F3n"),
                        React__default.createElement("hr", { className: "text-light" }),
                        React__default.createElement(LogosUnp, { src: "https://live.staticflickr.com/65535/54064468237_fb5a3edea2_z.jpg", size: "7em", alt: "Escudo Institucional Logos", height: "106px" }))),
                React__default.createElement(Col, { md: 6, className: "pt-4 pb-3 rounded-end bg-white" },
                    React__default.createElement(Row, { className: "justify-content-md-center text-center" },
                        React__default.createElement(LogosUnp, { size: "9em", src: "https://live.staticflickr.com/65535/54065780355_d6580531a4_q.jpg", alt: "Escudo Institucional UNP", height: "120px" }),
                        React__default.createElement("h4", { className: "mt-2" }, "Inicio de sesi\u00F3n")),
                    React__default.createElement(Row, { className: "justify-content-md-center mx-0" },
                        React__default.createElement("form", { method: "POST", noValidate: true, className: validated ? "was-validated" : "", onSubmit: function (e) { return handleSubmit(e, usuarioRef, contrasegnaRef, recaptchaRef); } },
                            React__default.createElement(Col, { xl: 12, md: 12, xs: 12, className: "justify-content-center" },
                                React__default.createElement(Usuario, { usuarioRef: usuarioRef }),
                                React__default.createElement(Contrasegna, { contrasegnaRef: contrasegnaRef })),
                            React__default.createElement(Col, { xl: 12, md: 12, xs: 12, className: "d-grid gap-2" },
                                React__default.createElement(Button, { variant: "secondary", disabled: isBlocked, type: "submit" }, isBlocked ? "Espera ".concat(timer, " segundos") : "Ingresar")),
                            React__default.createElement(Recaptcha, { onChange: handleRecaptchaChange, sitekey: "6LeC9F0qAAAAAJrKsyU-wpvYmDquDcAoqhH_oASk" }))),
                    error && (React__default.createElement(Alert$1, { className: "mt-3", key: "danger", variant: "danger" },
                        React__default.createElement(MdError, null),
                        " ",
                        error)))),
            React__default.createElement(Row, { className: "mt-2 d-flex justify-content-beetween" },
                React__default.createElement(Col, { className: "ms-0 d-flex justify-content-start" },
                    React__default.createElement(RedesSociales, { IconoRedSocial: FaXTwitter, color: "#000", descripcion: "@UNPColombia", enlace: "https://x.com/UNPColombia" }),
                    React__default.createElement(RedesSociales, { IconoRedSocial: FaInstagram, color: "#F00075", descripcion: "@unpcolombia", enlace: "https://www.instagram.com/unpcolombia" }),
                    React__default.createElement(RedesSociales, { IconoRedSocial: FaFacebook, color: "#1778F2", descripcion: "@UNPColombia", enlace: "https://www.facebook.com/UNPColombia" }),
                    React__default.createElement(RedesSociales, { IconoRedSocial: FaYoutube, color: "#FF0000", descripcion: "@unpcolombia", enlace: "https://www.youtube.com/channel/UCUiRLOI-MUqa7ATG-mJwY1w" }),
                    React__default.createElement(RedesSociales, { IconoRedSocial: FaHeadphones, color: '#1CCFF9', descripcion: "UNPRadio", enlace: "https://unpradio.unp.gov.co" }),
                    React__default.createElement(RedesSociales, { IconoRedSocial: FaPhoneFlip, color: '#D32929', descripcion: "L\u00EDnea Vida 103", enlace: "https://www.unp.gov.co/atencion-y-servicios-a-la-ciudadania/directorio/linea-vida-103" })),
                React__default.createElement(Col, { className: "me-0 d-flex justify-content-end align-items-center" },
                    React__default.createElement("a", { href: "https://www.unp.gov.co/normativa/politicas-de-seguridad-de-la-informacion-y-proteccion-de-datos-personales/", target: "_blank", rel: "noopener noreferrer", style: { textDecoration: 'none' } },
                        React__default.createElement("p", { className: "politica-datos" }, "Pol\u00EDticas de seguridad de la informaci\u00F3n y protecci\u00F3n de datos personales"))))),
...
var IniciarSesion = function () {
    ...
    React__default.createElement(IngresoProvider, null,
        React__default.createElement(Login, null)));
};

export { CardForm as C, IniciarSesion as I, SubtituloForm as S, TabVentana as T, VentanaLienzo as V, VentanaUsuario as a };
//# sourceMappingURL=InicioSesion-BmXcy79b.js.map
