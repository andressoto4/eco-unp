...
import { _ as _objectWithoutPropertiesLoose$7, u as useBootstrapPrefix, j as jsxRuntimeExports, c as classNames, r as divWithClassName, e as triggerBrowserReflow, T as TransitionWrapper, t as transitionEndListener, b as ENTERING, d as ENTERED, P as PropTypes, f as FormCheckInput, v as useMergedRefs, w as context$2, x as map, y as forEach, m as Container, R as Row, C as Col, n as Card, z as CardHeader, A as CardTitle, o as CardBody, G as GenIcon, B as requireReactIs, D as getDefaultExportFromCjs, i as FormGroup, k as FormLabel, l as FormControl, H as FaXTwitter, I as FaInstagram, J as FaFacebook, K as FaYoutube, L as FaHeadphones, M as FaPhoneFlip } from './index-FqMICwVR.js';
...
const SubtituloForm = ({ subtitulo, icon: Icon }) => {
...
const MenuLateral = ({ onToggle, isOpen }) => {
    ...
    return (React__default.createElement("div", { className: `container-fluid ${isOpen ? "menu-open" : ""}` },
...
const VentanaLienzo = ({ children }) => {
    ...
    return (React__default.createElement(React__default.Fragment, null,
        ...
        React__default.createElement("div", { className: `${menuOpen ? 'menu-open' : ''}` },
...
const VentanaUsuario = ({ children }) => {
    const [menuOpen, setMenuOpen] = React__default.useState(false);
    const [key, setKey] = React__default.useState(undefined);
    const handleToggle = () => {
        setMenuOpen(!menuOpen);
    };
    React__default.useEffect(() => {
        if (React__default.Children.count(children) > 0) {
            const firstTab = React__default.Children.toArray(children)[0];
    ...
    return (React__default.createElement(React__default.Fragment, null,
        ...
        React__default.createElement("div", { className: `${menuOpen ? 'menu-open' : ''}` },
            React__default.createElement("div", { className: `main-section` },
                React__default.createElement(Tabs, { id: "controlled-tab-example", activeKey: key, onSelect: (k) => setKey(k !== null ? k : undefined) }, React__default.Children.map(children, (child) => {
...
const IdUsuarioContext = React__default.createContext(undefined);
// Creación del contexto para el ID de la contraseña con un valor predeterminado indefinido
const IdContrasegnaContext = React__default.createContext(undefined);
...
const IngresoProvider = ({ children }) => {
    ...
    const [idUsuario, setIdUsuario] = React__default.useState("");
    // Estado para manejar el ID de la contraseña
    const [idContrasegna, setIdContrasegna] = React__default.useState("");
    // ------> Renderizado
    return (
    // Proveedor del contexto de ID del usuario
    React__default.createElement(IdUsuarioContext.Provider, { value: { idUsuario, setIdUsuario } },
        React__default.createElement(IdContrasegnaContext.Provider, { value: { idContrasegna, setIdContrasegna } }, children)));
};
...
const InicioSesionRequest = async (username, password, recaptchaToken) => {
    try {
...
const InicioSesionHook = (maxAttempts, blockTime) => {
    ...
    const handleSubmit = async (e, usuarioRef, contrasegnaRef, recaptchaRef) => {
        ...
        if (attempts < maxAttempts) {
            ...
            if (username && password) {
                try {
                    const data = await B.promise(InicioSesionRequest(username, password, recaptchaToken), {
                        pending: "Ingresando...",
                        success: {
                            render({ data }) {
                                alert('estoy aquí');
        ...
        React__default.createElement(Col, { xl: 12, md: 12, xs: 12 },
            React__default.createElement(FormGroup, { className: "mb-3", controlId: "validacionContrasegna" },
                ...
                React__default.createElement(InputGroup$1, null,
                    ...
                    React__default.createElement(Button, { type: "button", className: "rounded-end", variant: "secondary", onClick: () => {
...
const RedesSociales = ({ color, IconoRedSocial, descripcion, enlace }) => {
    ...
    return (React__default.createElement("a", { href: enlace, target: "_blank", rel: "noopener noreferrer", style: { textDecoration: 'none' } },
        React__default.createElement("div", { style: style, onMouseEnter: () => setIsHovered(true), onMouseLeave: () => setIsHovered(false) },
...
const Login = (props) => {
    ...
    const usuarioRef = React__default.useRef(null);
    const contrasegnaRef = React__default.useRef(null);
    const recaptchaRef = React__default.useRef(null);
            ...
            React__default.createElement(Row, { className: "justify-content-md-center border-0 rounded shadow" },
                ...
                React__default.createElement(Col, { md: 6, className: "pt-4 pb-3 rounded-end bg-white" },
                    ...
                    React__default.createElement(Row, { className: "justify-content-md-center mx-0" },
                        React__default.createElement("form", { method: "POST", noValidate: true, className: validated ? "was-validated" : "", onSubmit: (e) => handleSubmit(e, usuarioRef, contrasegnaRef, recaptchaRef) },
                            ...
                            React__default.createElement(Col, { xl: 12, md: 12, xs: 12, className: "d-grid gap-2" },
                                React__default.createElement(Button, { variant: "secondary", disabled: isBlocked, type: "submit" }, isBlocked ? `Espera ${timer} segundos` : "Ingresar")),
...
//# sourceMappingURL=InicioSesion-CZJd1Efm.js.map
