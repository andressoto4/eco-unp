...
var tslib_es6 = require('./tslib.es6-nvSHNY1m.js');
...
function useUncontrolled(props, config) {
  return Object.keys(config).reduce(function (result, fieldName) {
    ...
    var _ref = result,
        ...
        rest = tslib_es6._objectWithoutPropertiesLoose(_ref, [defaultKey(fieldName), fieldName].map(_toPropertyKey));
...
const DivStyledAsH4 = tslib_es6.divWithClassName('h4');
DivStyledAsH4.displayName = 'DivStyledAsH4';
const AlertHeading = /*#__PURE__*/React__namespace.forwardRef(({
  className,
  bsPrefix,
  as: Component = DivStyledAsH4,
  ...props
}, ref) => {
  bsPrefix = tslib_es6.useBootstrapPrefix(bsPrefix, 'alert-heading');
  return /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(Component, {
    ref: ref,
    className: tslib_es6.classNames(className, bsPrefix),
    ...props
  });
});
...
const Button$1 = /*#__PURE__*/React__namespace.forwardRef((_ref, ref) => {
  ...
  return /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(Component, Object.assign({}, props, buttonProps, {
    ref: ref
  }));
});
...
const Anchor = /*#__PURE__*/React__namespace.forwardRef((_ref, ref) => {
  ...
  if (isTrivialHref(props.href) || props.role === 'button') {
    return /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx("a", Object.assign({
      ref: ref
    }, props, buttonProps, {
      onKeyDown: handleKeyDown
    }));
...
const AlertLink = /*#__PURE__*/React__namespace.forwardRef(({
  className,
  bsPrefix,
  as: Component = Anchor,
  ...props
}, ref) => {
  bsPrefix = tslib_es6.useBootstrapPrefix(bsPrefix, 'alert-link');
  return /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(Component, {
    ref: ref,
    className: tslib_es6.classNames(className, bsPrefix),
    ...props
...
const fadeStyles = {
  [tslib_es6.ENTERING]: 'show',
  [tslib_es6.ENTERED]: 'show'
};
const Fade = /*#__PURE__*/React__namespace.forwardRef(({
  ...
  const handleEnter = React.useCallback((node, isAppearing) => {
    tslib_es6.triggerBrowserReflow(node);
  ...
  return /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(tslib_es6.TransitionWrapper, {
    ref: ref,
    addEndListener: tslib_es6.transitionEndListener,
    ...props,
    onEnter: handleEnter,
    childRef: childRef,
    children: (status, innerProps) => /*#__PURE__*/React__namespace.cloneElement(children, {
      ...innerProps,
      className: tslib_es6.classNames('fade', className, children.props.className, fadeStyles[status], transitionClasses[status])
    })
  });
});
...
const propTypes$1 = {
  ...
  'aria-label': tslib_es6.PropTypes.string,
  /** A callback fired after the Close Button is clicked. */
  onClick: tslib_es6.PropTypes.func,
  /**
   * Render different color variant for the button.
   *
   * Omitting this will render the default dark color.
   */
  variant: tslib_es6.PropTypes.oneOf(['white'])
};
const CloseButton = /*#__PURE__*/React__namespace.forwardRef(({
  ...
  ...props
}, ref) => /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx("button", {
  ref: ref,
  type: "button",
  className: tslib_es6.classNames('btn-close', variant && `btn-close-${variant}`, className),
...
const Alert = /*#__PURE__*/React__namespace.forwardRef((uncontrolledProps, ref) => {
  const {
    bsPrefix,
    show = true,
  ...
  const prefix = tslib_es6.useBootstrapPrefix(bsPrefix, 'alert');
  ...
  const alert = /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsxs("div", {
    role: "alert",
    ...(!Transition ? props : undefined),
    ref: ref,
    className: tslib_es6.classNames(className, prefix, variant && `${prefix}-${variant}`, dismissible && `${prefix}-dismissible`),
    children: [dismissible && /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(CloseButton, {
      onClick: handleClose,
  ...
  return /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(Transition, {
    unmountOnExit: true,
    ...props,
    ref: undefined,
    in: show,
...
const Button = /*#__PURE__*/React__namespace.forwardRef(({
  ...
  const prefix = tslib_es6.useBootstrapPrefix(bsPrefix, 'btn');
  const [buttonProps, {
    tagName
  }] = useButtonProps({
    tagName: as,
  ...
  return /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(Component, {
    ...
    ref: ref,
    disabled: disabled,
    className: tslib_es6.classNames(className, prefix, active && 'active', variant && `${prefix}-${variant}`, size && `${prefix}-${size}`, props.href && disabled && 'disabled')
  });
});
...
const InputGroupText = /*#__PURE__*/React__namespace.forwardRef(({
  ...
  bsPrefix = tslib_es6.useBootstrapPrefix(bsPrefix, 'input-group-text');
  return /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(Component, {
    ref: ref,
    className: tslib_es6.classNames(className, bsPrefix),
    ...props
...
const InputGroupCheckbox = props => /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(InputGroupText, {
  children: /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(tslib_es6.FormCheckInput, {
    type: "checkbox",
    ...props
  })
});
const InputGroupRadio = props => /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(InputGroupText, {
  children: /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(tslib_es6.FormCheckInput, {
    type: "radio",
    ...props
  })
...
const InputGroup = /*#__PURE__*/React__namespace.forwardRef(({
  ...
  bsPrefix = tslib_es6.useBootstrapPrefix(bsPrefix, 'input-group');

  // Intentionally an empty object. Used in detecting if a dropdown
  // exists under an input group.
  const contextValue = React.useMemo(() => ({}), []);
  return /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(context$1.Provider, {
    value: contextValue,
    children: /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(Component, {
      ref: ref,
      ...props,
      className: tslib_es6.classNames(className, bsPrefix, size && `${bsPrefix}-${size}`, hasValidation && 'has-validation')
    })
  });
});
...
const NavItem$1 = /*#__PURE__*/React__namespace.forwardRef((_ref, ref) => {
  ...
  return /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(Component, Object.assign({}, options, props, {
    ref: ref
  }));
});
...
const Nav$2 = /*#__PURE__*/React__namespace.forwardRef((_ref, ref) => {
  ...
  const mergedRef = tslib_es6.useMergedRefs(ref, listNode);
  return /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(SelectableContext.Provider, {
    value: handleSelect,
    children: /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(NavContext.Provider, {
      value: {
        role,
      ...
      children: /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(Component, Object.assign({}, props, {
        onKeyDown: handleKeyDown,
        ref: mergedRef,
        role: role
      }))
...
function NoopTransition({
  ...
  const combinedRef = tslib_es6.useMergedRefs(ref, children.ref);
...
const NavItem = /*#__PURE__*/React__namespace.forwardRef(({
  className,
  bsPrefix,
  as: Component = 'div',
  ...props
}, ref) => {
  bsPrefix = tslib_es6.useBootstrapPrefix(bsPrefix, 'nav-item');
  return /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(Component, {
    ref: ref,
    className: tslib_es6.classNames(className, bsPrefix),
    ...props
...
const NavLink = /*#__PURE__*/React__namespace.forwardRef(({
  ...
  bsPrefix = tslib_es6.useBootstrapPrefix(bsPrefix, 'nav-link');
  ...
  return /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(Component, {
    ...
    ref: ref,
    disabled: disabled,
    className: tslib_es6.classNames(className, bsPrefix, disabled && 'disabled', meta.isActive && 'active')
  });
});
...
const Nav = /*#__PURE__*/React__namespace.forwardRef((uncontrolledProps, ref) => {
  ...
  const bsPrefix = tslib_es6.useBootstrapPrefix(initialBsPrefix, 'nav');
  let navbarBsPrefix;
  let cardHeaderBsPrefix;
  let isNavbar = false;
  const navbarContext = React.useContext(context);
  const cardHeaderContext = React.useContext(tslib_es6.context);
  if (navbarContext) {
  ...
  return /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(BaseNav, {
    as: as,
    ref: ref,
    activeKey: activeKey,
    className: tslib_es6.classNames(className, {
      [bsPrefix]: !isNavbar,
...
(_ref2, ref) => {
  ...
  return /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(TabContext.Provider, {
    value: null,
    children: /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(SelectableContext.Provider, {
      value: null,
      children: /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(Transition, {
        in: isActive,
        onEnter: onEnter,
        ...
        children: /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(Component, Object.assign({}, tabPanelProps, {
          ref: ref,
          hidden: !isActive,
...
const TabContainer = ({
  transition,
  ...props
}) => /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(Tabs$1, {
  ...props,
  transition: getTabTransitionComponent(transition)
});
TabContainer.displayName = 'TabContainer';

const TabContent = /*#__PURE__*/React__namespace.forwardRef(({
  className,
  bsPrefix,
  as: Component = 'div',
  ...props
}, ref) => {
  bsPrefix = tslib_es6.useBootstrapPrefix(bsPrefix, 'tab-content');
  return /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(Component, {
    ref: ref,
    className: tslib_es6.classNames(className, bsPrefix),
    ...props
...
const TabPane = /*#__PURE__*/React__namespace.forwardRef(({
  ...
  const prefix = tslib_es6.useBootstrapPrefix(bsPrefix, 'tab-pane');
    ...
    children: /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(SelectableContext.Provider, {
      ...
      children: /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(Transition, {
        ...
        children: /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(Component, {
          ...rest,
          ref: ref,
          className: tslib_es6.classNames(className, prefix, isActive && 'active')
        })
      })
    })
  });
...
const propTypes = {
  eventKey: tslib_es6.PropTypes.oneOfType([tslib_es6.PropTypes.string, tslib_es6.PropTypes.number]),
  /**
   * Content for the tab title.
   */
  title: tslib_es6.PropTypes.node.isRequired,
  /**
   * The disabled state of the tab.
   */
  disabled: tslib_es6.PropTypes.bool,
  /**
   * Class to pass to the underlying nav link.
   */
  tabClassName: tslib_es6.PropTypes.string,
  /**
   * Object containing attributes to pass to underlying nav link.
   */
  tabAttrs: tslib_es6.PropTypes.object
};
const Tab = () => {
...
function getDefaultActiveKey(children) {
  ...
  tslib_es6.forEach(children, child => {
...
function renderTab(child) {
  ...
  return /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(NavItem, {
    as: "li",
    role: "presentation",
    children: /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(NavLink, {
      as: "button",
      type: "button",
      eventKey: eventKey,
      disabled: disabled,
...
const Tabs = props => {
  ...
  return /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsxs(Tabs$1, {
    id: id,
    activeKey: activeKey,
    onSelect: onSelect,
    transition: getTabTransitionComponent(transition),
    mountOnEnter: mountOnEnter,
    unmountOnExit: unmountOnExit,
    children: [/*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(Nav$1, {
      id: id,
      ...controlledProps,
      role: "tablist",
      as: "ul",
      variant: variant,
      children: tslib_es6.map(children, renderTab)
    }), /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(TabContent, {
      children: tslib_es6.map(children, child => {
        const childProps = {
          ...child.props
        };
        ...
        return /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(TabPane, {
          ...childProps
        });
      })
    })]
...
var CardForm = function (_a) {
    ...
    return (React.createElement(tslib_es6.Container, { className: "py-5" },
        React.createElement(tslib_es6.Row, { className: "justify-content-center" },
            React.createElement(tslib_es6.Col, { xl: 10, md: 11, xs: 12 },
                React.createElement(tslib_es6.Card, { style: borderUnpStyle, className: "border-0 rounded-3 shadow" },
                    React.createElement(tslib_es6.CardHeader, { style: bgUnpStyle, className: "text-center text-light rounded-3 rounded-bottom-0 py-4" },
                        React.createElement(tslib_es6.CardTitle, { className: "px-xs-0 px-md-1 pd-lg-2" },
                            React.createElement("h4", null, titulo))),
                    React.createElement(tslib_es6.CardBody, { className: "px-4" },
                        React.createElement("form", { method: method },
                            children,
                            React.createElement(tslib_es6.Row, { className: "d-flex justify-content-end me-0" },
...
var SubtituloForm = function (_a) {
    ...
    return (React.createElement(tslib_es6.Row, { className: 'mb-1 mt-3' },
        React.createElement(tslib_es6.Col, { className: "col-auto pe-1" },
            React.createElement(Icon, { style: iconStyle })),
        React.createElement(tslib_es6.Col, { className: "ps-1 col-auto align-self-center" },
...
var TabVentana = function (_a) {
    ...
    return (React.createElement(Tab$1, { eventKey: eventKey, title: title }, children));
};

// THIS FILE IS AUTO GENERATED
function BiAnalyse (props) {
  return tslib_es6.GenIcon({"tag":"svg","attr":{"viewBox":"0 0 24 24"},"child":[{"tag":"path","attr":{"d":"M2 12h2a7.986 7.986 0 0 1 2.337-5.663 7.91 7.91 0 0 1 2.542-1.71 8.12 8.12 0 0 1 6.13-.041A2.488 2.488 0 0 0 17.5 7C18.886 7 20 5.886 20 4.5S18.886 2 17.5 2c-.689 0-1.312.276-1.763.725-2.431-.973-5.223-.958-7.635.059a9.928 9.928 0 0 0-3.18 2.139 9.92 9.92 0 0 0-2.14 3.179A10.005 10.005 0 0 0 2 12zm17.373 3.122c-.401.952-.977 1.808-1.71 2.541s-1.589 1.309-2.542 1.71a8.12 8.12 0 0 1-6.13.041A2.488 2.488 0 0 0 6.5 17C5.114 17 4 18.114 4 19.5S5.114 22 6.5 22c.689 0 1.312-.276 1.763-.725A9.965 9.965 0 0 0 12 22a9.983 9.983 0 0 0 9.217-6.102A9.992 9.992 0 0 0 22 12h-2a7.993 7.993 0 0 1-.627 3.122z"},"child":[]},{"tag":"path","attr":{"d":"M12 7.462c-2.502 0-4.538 2.036-4.538 4.538S9.498 16.538 12 16.538s4.538-2.036 4.538-4.538S14.502 7.462 12 7.462zm0 7.076c-1.399 0-2.538-1.139-2.538-2.538S10.601 9.462 12 9.462s2.538 1.139 2.538 2.538-1.139 2.538-2.538 2.538z"},"child":[]}]})(props);
}function BiBookAlt (props) {
  return tslib_es6.GenIcon({"tag":"svg","attr":{"viewBox":"0 0 24 24"},"child":[{"tag":"path","attr":{"d":"M19 2H6c-1.206 0-3 .799-3 3v14c0 2.201 1.794 3 3 3h15v-2H6.012C5.55 19.988 5 19.806 5 19s.55-.988 1.012-1H21V4c0-1.103-.897-2-2-2zm0 14H5V5c0-.806.55-.988 1-1h13v12z"},"child":[]}]})(props);
}function BiEnvelope (props) {
  return tslib_es6.GenIcon({"tag":"svg","attr":{"viewBox":"0 0 24 24"},"child":[{"tag":"path","attr":{"d":"M20 4H4c-1.103 0-2 .897-2 2v12c0 1.103.897 2 2 2h16c1.103 0 2-.897 2-2V6c0-1.103-.897-2-2-2zm0 2v.511l-8 6.223-8-6.222V6h16zM4 18V9.044l7.386 5.745a.994.994 0 0 0 1.228 0L20 9.044 20.002 18H4z"},"child":[]}]})(props);
}function BiErrorCircle (props) {
  return tslib_es6.GenIcon({"tag":"svg","attr":{"viewBox":"0 0 24 24"},"child":[{"tag":"path","attr":{"d":"M11.953 2C6.465 2 2 6.486 2 12s4.486 10 10 10 10-4.486 10-10S17.493 2 11.953 2zM12 20c-4.411 0-8-3.589-8-8s3.567-8 7.953-8C16.391 4 20 7.589 20 12s-3.589 8-8 8z"},"child":[]},{"tag":"path","attr":{"d":"M11 7h2v7h-2zm0 8h2v2h-2z"},"child":[]}]})(props);
}function BiHome (props) {
  return tslib_es6.GenIcon({"tag":"svg","attr":{"viewBox":"0 0 24 24"},"child":[{"tag":"path","attr":{"d":"M3 13h1v7c0 1.103.897 2 2 2h12c1.103 0 2-.897 2-2v-7h1a1 1 0 0 0 .707-1.707l-9-9a.999.999 0 0 0-1.414 0l-9 9A1 1 0 0 0 3 13zm7 7v-5h4v5h-4zm2-15.586 6 6V15l.001 5H16v-5c0-1.103-.897-2-2-2h-4c-1.103 0-2 .897-2 2v5H6v-9.586l6-6z"},"child":[]}]})(props);
}function BiLinkAlt (props) {
  return tslib_es6.GenIcon({"tag":"svg","attr":{"viewBox":"0 0 24 24"},"child":[{"tag":"path","attr":{"d":"M4.222 19.778a4.983 4.983 0 0 0 3.535 1.462 4.986 4.986 0 0 0 3.536-1.462l2.828-2.829-1.414-1.414-2.828 2.829a3.007 3.007 0 0 1-4.243 0 3.005 3.005 0 0 1 0-4.243l2.829-2.828-1.414-1.414-2.829 2.828a5.006 5.006 0 0 0 0 7.071zm15.556-8.485a5.008 5.008 0 0 0 0-7.071 5.006 5.006 0 0 0-7.071 0L9.879 7.051l1.414 1.414 2.828-2.829a3.007 3.007 0 0 1 4.243 0 3.005 3.005 0 0 1 0 4.243l-2.829 2.828 1.414 1.414 2.829-2.828z"},"child":[]},{"tag":"path","attr":{"d":"m8.464 16.95-1.415-1.414 8.487-8.486 1.414 1.415z"},"child":[]}]})(props);
}function BiLogOut (props) {
  return tslib_es6.GenIcon({"tag":"svg","attr":{"viewBox":"0 0 24 24"},"child":[{"tag":"path","attr":{"d":"M16 13v-2H7V8l-5 4 5 4v-3z"},"child":[]},{"tag":"path","attr":{"d":"M20 3h-9c-1.103 0-2 .897-2 2v4h2V5h9v14h-9v-4H9v4c0 1.103.897 2 2 2h9c1.103 0 2-.897 2-2V5c0-1.103-.897-2-2-2z"},"child":[]}]})(props);
}function BiMapPin (props) {
  return tslib_es6.GenIcon({"tag":"svg","attr":{"viewBox":"0 0 24 24"},"child":[{"tag":"path","attr":{"d":"m12 17 1-2V9.858c1.721-.447 3-2 3-3.858 0-2.206-1.794-4-4-4S8 3.794 8 6c0 1.858 1.279 3.411 3 3.858V15l1 2zM10 6c0-1.103.897-2 2-2s2 .897 2 2-.897 2-2 2-2-.897-2-2z"},"child":[]},{"tag":"path","attr":{"d":"m16.267 10.563-.533 1.928C18.325 13.207 20 14.584 20 16c0 1.892-3.285 4-8 4s-8-2.108-8-4c0-1.416 1.675-2.793 4.267-3.51l-.533-1.928C4.197 11.54 2 13.623 2 16c0 3.364 4.393 6 10 6s10-2.636 10-6c0-2.377-2.197-4.46-5.733-5.437z"},"child":[]}]})(props);
}function BiMenuAltRight (props) {
  return tslib_es6.GenIcon({"tag":"svg","attr":{"viewBox":"0 0 24 24"},"child":[{"tag":"path","attr":{"d":"M4 6h16v2H4zm4 5h12v2H8zm5 5h7v2h-7z"},"child":[]}]})(props);
}function BiMenu (props) {
  return tslib_es6.GenIcon({"tag":"svg","attr":{"viewBox":"0 0 24 24"},"child":[{"tag":"path","attr":{"d":"M4 6h16v2H4zm0 5h16v2H4zm0 5h16v2H4z"},"child":[]}]})(props);
}function BiShieldPlus (props) {
  return tslib_es6.GenIcon({"tag":"svg","attr":{"viewBox":"0 0 24 24"},"child":[{"tag":"path","attr":{"d":"M11.63 21.91A.9.9 0 0 0 12 22a1 1 0 0 0 .41-.09C22 17.67 21 7 21 6.9a1 1 0 0 0-.55-.79l-8-4a1 1 0 0 0-.9 0l-8 4A1 1 0 0 0 3 6.9c0 .1-.92 10.77 8.63 15.01zM5 7.63l7-3.51 7 3.51c.05 2-.27 9-7 12.27C5.26 16.63 4.94 9.64 5 7.63z"},"child":[]},{"tag":"path","attr":{"d":"M11.06 16h2v-3h3.01v-2h-3.01V8h-2v3h-3v2h3v3z"},"child":[]}]})(props);
}function BiSolidPlaneAlt (props) {
  return tslib_es6.GenIcon({"tag":"svg","attr":{"viewBox":"0 0 24 24"},"child":[{"tag":"path","attr":{"d":"M3.414 13.778 2 15.192l4.949 2.121 2.122 4.95 1.414-1.414-.707-3.536L13.091 14l3.61 7.704 1.339-1.339-1.19-10.123 2.828-2.829a2 2 0 1 0-2.828-2.828l-2.903 2.903L3.824 6.297 2.559 7.563l7.644 3.67-3.253 3.253-3.536-.708z"},"child":[]}]})(props);
}function BiLogoRedux (props) {
  return tslib_es6.GenIcon({"tag":"svg","attr":{"viewBox":"0 0 24 24"},"child":[{"tag":"path","attr":{"d":"M15.661 15.549a1.315 1.315 0 0 0 1.185-1.386 1.363 1.363 0 0 0-1.35-1.302h-.048a1.352 1.352 0 0 0-1.303 1.397c.024.379.179.687.391.911-.827 1.609-2.07 2.794-3.954 3.788-1.266.663-2.604.912-3.905.734-1.089-.153-1.94-.64-2.463-1.421-.78-1.185-.852-2.462-.201-3.74a5.597 5.597 0 0 1 1.658-1.931 7.88 7.88 0 0 1-.331-1.218c-3.506 2.51-3.148 5.942-2.084 7.564.794 1.184 2.415 1.941 4.19 1.941.474 0 .972-.035 1.457-.154 3.077-.592 5.409-2.438 6.747-5.16l.011-.023z"},"child":[]},{"tag":"path","attr":{"d":"M19.887 12.589c-1.834-2.154-4.533-3.337-7.611-3.337h-.403c-.2-.438-.661-.711-1.183-.711h-.036c-.744 0-1.325.64-1.301 1.385.023.71.627 1.302 1.35 1.302h.059a1.332 1.332 0 0 0 1.183-.828h.439c1.824 0 3.551.532 5.126 1.574 1.206.792 2.072 1.834 2.557 3.077.425 1.019.402 2.013-.035 2.843-.675 1.302-1.812 1.988-3.314 1.988-.947 0-1.871-.296-2.345-.509-.283.235-.758.626-1.102.863 1.042.473 2.096.746 3.113.746 2.309 0 4.023-1.302 4.676-2.557.709-1.422.651-3.813-1.161-5.859l-.012.023z"},"child":[]},{"tag":"path","attr":{"d":"M7.647 15.975c.023.71.626 1.302 1.35 1.302h.048a1.334 1.334 0 0 0 1.302-1.397c0-.71-.616-1.301-1.338-1.301h-.048c-.048 0-.118 0-.178.022-.982-1.657-1.397-3.434-1.242-5.349.094-1.445.567-2.7 1.42-3.742.71-.888 2.048-1.326 2.96-1.35 2.556-.048 3.622 3.138 3.704 4.404l1.184.354C16.536 5.036 14.122 3 11.813 3 9.647 3 7.647 4.574 6.842 6.884c-1.102 3.077-.379 6.036.971 8.404-.118.154-.189.426-.166.687z"},"child":[]}]})(props);
}
...
var NotificacionUsuario = function () {
    return (React.createElement(FaBell, { style: { width: '25px', height: '25px' } }));
};
...
function MdError (props) {
  return tslib_es6.GenIcon({"tag":"svg","attr":{"viewBox":"0 0 24 24"},"child":[{"tag":"path","attr":{"fill":"none","d":"M0 0h24v24H0z"},"child":[]},{"tag":"path","attr":{"d":"M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z"},"child":[]}]})(props);
}
...
var InicioSesionHook = function (maxAttempts, blockTime) {
    var _a = React.useState(null), recaptchaToken = _a[0], setRecaptchaToken = _a[1];
    var _b = React.useState(false), validated = _b[0], setValidated = _b[1];
    var _c = React.useState(null), error = _c[0], setError = _c[1];
    var _d = React.useState(0), attempts = _d[0], setAttempts = _d[1];
    var _e = React.useState(false), isBlocked = _e[0], setIsBlocked = _e[1];
    var _f = React.useState(0), timer = _f[0], setTimer = _f[1];
    React.useEffect(function () {
        var interval;
    ...
    var handleSubmit = function (e, usuarioRef, contrasegnaRef, recaptchaRef) { return tslib_es6.__awaiter(void 0, void 0, void 0, function () {
...
ReCAPTCHA.propTypes = {
  sitekey: tslib_es6.PropTypes.string.isRequired,
  onChange: tslib_es6.PropTypes.func,
  grecaptcha: tslib_es6.PropTypes.object,
  theme: tslib_es6.PropTypes.oneOf(["dark", "light"]),
  type: tslib_es6.PropTypes.oneOf(["image", "audio"]),
  tabindex: tslib_es6.PropTypes.number,
  onExpired: tslib_es6.PropTypes.func,
  onErrored: tslib_es6.PropTypes.func,
  size: tslib_es6.PropTypes.oneOf(["compact", "normal", "invisible"]),
  stoken: tslib_es6.PropTypes.string,
  hl: tslib_es6.PropTypes.string,
  badge: tslib_es6.PropTypes.oneOf(["bottomright", "bottomleft", "inline"]),
  isolated: tslib_es6.PropTypes.bool
};
...
function requireHoistNonReactStatics_cjs () {
	...
	var reactIs = tslib_es6.requireReactIs();
...
var hoistStatics = /*@__PURE__*/tslib_es6.getDefaultExportFromCjs(hoistNonReactStatics_cjsExports);
...
function makeAsyncScript(getScriptURL, options) {
  ...
  return function wrapWithAsyncScript(WrappedComponent) {
    ...
    ForwardedComponent.propTypes = {
      asyncScriptOnLoad: tslib_es6.PropTypes.func
    };
...
var Recaptcha = function (_a) {
    ...
    var _b = React.useState(false), loaded = _b[0], setLoaded = _b[1];
    var _c = React.useState(null), error = _c[0], setError = _c[1];
    var _d = React.useState(0), key = _d[0], setKey = _d[1];
    ...
    return (React.createElement(tslib_es6.Col, { xl: 12, md: 9, xs: 12, className: "d-flex justify-content-center mt-4 mb-2", style: { width: '308px', height: '80px' } },
        ...
        React.createElement(RecaptchaWrapper, { key: key, ref: recaptchaRef, className: "mb-3", sitekey: sitekey, onChange: handleCaptchaChange, onLoad: handleCaptchaLoad, onErrored: handleCaptchaError })));
};
...
var Usuario = function (_a) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(tslib_es6.Col, { xl: 12, md: 12, xs: 12 },
            React.createElement(tslib_es6.FormGroup, { className: "mb-3", controlId: "validacionUsuario" },
                React.createElement(tslib_es6.FormLabel, null, "Usuario"),
                React.createElement(InputGroup$1, null,
                    React.createElement(InputGroup$1.Text, { id: "email-icon" },
                        React.createElement(FaUser, null)),
                    React.createElement(tslib_es6.FormControl, { className: "rounded-end", type: "text", ref: usuarioRef, value: usuario, onChange: handleUsuarioChange, onInput: handleUsuarioChange, placeholder: "nombre.apellido", pattern: "^[a-z]+\\.[a-z]+$", maxLength: 100, isInvalid: !isValid, required: true }))))));
};
var Contrasegna = function (_a) {
    var contrasegnaRef = _a.contrasegnaRef;
    var contrasegnaContext = React.useContext(IdContrasegnaContext);
    ...
    var _b = React.useState(""), contrasegna = _b[0], setContrasegna = _b[1];
    var _c = React.useState(false), showPassword = _c[0], setShowPassword = _c[1];
    var _d = React.useState(false), isValid = _d[0], setIsValid = _d[1];
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(tslib_es6.Col, { xl: 12, md: 12, xs: 12 },
            React.createElement(tslib_es6.FormGroup, { className: "mb-3", controlId: "validacionContrasegna" },
                React.createElement(tslib_es6.FormLabel, null, "Contrase\u00F1a"),
                React.createElement(InputGroup$1, null,
                    React.createElement(InputGroup$1.Text, { id: "password-icon" },
                        React.createElement(RiLockPasswordFill, null)),
                    React.createElement(tslib_es6.FormControl, { type: showPassword ? "text" : "password", ref: contrasegnaRef, value: contrasegna, onChange: handleContrasegnaChange, placeholder: "*****************", maxLength: 100, isValid: isValid, required: true }),
                    ...
                    React.createElement(tslib_es6.FormControl.Feedback, { type: "invalid" }, "Por favor ingresa una contrasegna"))))));
};
...
var Login = function (props) {
    ...
    React.createElement("div", { className: "login-container" },
        React.createElement(tslib_es6.Container, { style: { maxWidth: "720px" } },
            React.createElement(tslib_es6.Row, { className: "justify-content-md-center border-0 rounded shadow" },
                React.createElement(tslib_es6.Col, { md: 6, className: "bg-form align-content-center px-5 rounded-start" },
                    React.createElement(tslib_es6.Row, { className: "justify-content-md-center" },
                ...
                React.createElement(tslib_es6.Col, { md: 6, className: "pt-4 pb-3 rounded-end bg-white" },
                    React.createElement(tslib_es6.Row, { className: "justify-content-md-center text-center" },
                    ...
                    React.createElement(tslib_es6.Row, { className: "justify-content-md-center mx-0" },
                        React.createElement("form", { method: "POST", noValidate: true, className: validated ? "was-validated" : "", onSubmit: function (e) { return handleSubmit(e, usuarioRef, contrasegnaRef, recaptchaRef); } },
                            React.createElement(tslib_es6.Col, { xl: 12, md: 12, xs: 12, className: "justify-content-center" },
                                React.createElement(Usuario, { usuarioRef: usuarioRef }),
                                React.createElement(Contrasegna, { contrasegnaRef: contrasegnaRef })),
                            React.createElement(tslib_es6.Col, { xl: 12, md: 12, xs: 12, className: "d-grid gap-2" },
                    ...
                    error && (React.createElement(Alert$1, { className: "mt-3", key: "danger", variant: "danger" },
                        React.createElement(MdError, null),
                        " ",
                        error)))),
            React.createElement(tslib_es6.Row, { className: "mt-2 d-flex justify-content-beetween" },
                React.createElement(tslib_es6.Col, { className: "ms-0 d-flex justify-content-start" },
                    React.createElement(RedesSociales, { IconoRedSocial: tslib_es6.FaXTwitter, color: "#000", descripcion: "@UNPColombia", enlace: "https://x.com/UNPColombia" }),
                    React.createElement(RedesSociales, { IconoRedSocial: tslib_es6.FaInstagram, color: "#F00075", descripcion: "@unpcolombia", enlace: "https://www.instagram.com/unpcolombia" }),
                    React.createElement(RedesSociales, { IconoRedSocial: tslib_es6.FaFacebook, color: "#1778F2", descripcion: "@UNPColombia", enlace: "https://www.facebook.com/UNPColombia" }),
                    React.createElement(RedesSociales, { IconoRedSocial: tslib_es6.FaYoutube, color: "#FF0000", descripcion: "@unpcolombia", enlace: "https://www.youtube.com/channel/UCUiRLOI-MUqa7ATG-mJwY1w" }),
                    React.createElement(RedesSociales, { IconoRedSocial: tslib_es6.FaHeadphones, color: '#1CCFF9', descripcion: "UNPRadio", enlace: "https://unpradio.unp.gov.co" }),
                    React.createElement(RedesSociales, { IconoRedSocial: tslib_es6.FaPhoneFlip, color: '#D32929', descripcion: "L\u00EDnea Vida 103", enlace: "https://www.unp.gov.co/atencion-y-servicios-a-la-ciudadania/directorio/linea-vida-103" })),
                React.createElement(tslib_es6.Col, { className: "me-0 d-flex justify-content-end align-items-center" },
...
exports.SubtituloForm = SubtituloForm;
exports.TabVentana = TabVentana;
exports.VentanaLienzo = VentanaLienzo;
exports.VentanaUsuario = VentanaUsuario;
//# sourceMappingURL=InicioSesion-_eNeb1_p.js.map
