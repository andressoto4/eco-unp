...
function getDefaultDimensionValue(dimension, elem) {
  ...
  return value +
  // @ts-ignore
  parseInt(tslib_es6.style(elem, margins[0]), 10) +
  // @ts-ignore
  parseInt(tslib_es6.style(elem, margins[1]), 10);
}
const collapseStyles = {
  [tslib_es6.EXITED]: 'collapse',
  [tslib_es6.EXITING]: 'collapsing',
  [tslib_es6.ENTERING]: 'collapsing',
  [tslib_es6.ENTERED]: 'collapse show'
};
const Collapse = /*#__PURE__*/React.forwardRef(({
  ...
  const handleExit = React.useMemo(() => createChainedFunction(elem => {
    ...
    tslib_es6.triggerBrowserReflow(elem);
  ...
  return /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(tslib_es6.TransitionWrapper, {
    ...
    children: (state, innerProps) => /*#__PURE__*/React.cloneElement(children, {
      ...innerProps,
      className: tslib_es6.classNames(className, children.props.className, collapseStyles[state], computedDimension === 'width' && 'collapse-horizontal')
    })
  });
});
...
const FormCheckLabel = /*#__PURE__*/React__namespace.forwardRef(({
  ...
  const {
    controlId
  } = React.useContext(tslib_es6.FormContext);
  bsPrefix = tslib_es6.useBootstrapPrefix(bsPrefix, 'form-check-label');
  return /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx("label", {
    ...props,
    ref: ref,
...
const FormCheck = /*#__PURE__*/React__namespace.forwardRef(({
  ...
  bsPrefix = tslib_es6.useBootstrapPrefix(bsPrefix, 'form-check');
  bsSwitchPrefix = tslib_es6.useBootstrapPrefix(bsSwitchPrefix, 'form-switch');
  const {
    controlId
  } = React.useContext(tslib_es6.FormContext);
  ...
  const hasLabel = !children && label != null && label !== false || tslib_es6.hasChildOfType(children, FormCheckLabel);
  const input = /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(tslib_es6.FormCheckInput, {
    ...props,
  ...
  return /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(tslib_es6.FormContext.Provider, {
    value: innerFormContext,
    children: /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx("div", {
      style: style,
      className: tslib_es6.classNames(className, hasLabel && bsPrefix, inline && `${bsPrefix}-inline`, reverse && `${bsPrefix}-reverse`, type === 'switch' && bsSwitchPrefix),
      children: children || /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsxs(tslib_es6.jsxRuntimeExports.Fragment, {
        children: [input, hasLabel && /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(FormCheckLabel, {
          title: title,
          children: label
        }), feedback && /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx(tslib_es6.Feedback, {
          type: feedbackType,
...
var FormCheck$1 = Object.assign(FormCheck, {
  Input: tslib_es6.FormCheckInput,
...
const FormSelect = /*#__PURE__*/React__namespace.forwardRef(({
  ...
  bsPrefix = tslib_es6.useBootstrapPrefix(bsPrefix, 'form-select');
  return /*#__PURE__*/tslib_es6.jsxRuntimeExports.jsx("select", {
    ...props,
    size: htmlSize,
    ref: ref,
    className: tslib_es6.classNames(className, bsPrefix, size && `${bsPrefix}-${size}`, isValid && `is-valid`, isInvalid && `is-invalid`),
    id: id || controlId
  });
});
...
var ContactoPersona = function () {
    return (React.createElement(tslib_es6.Row, null,
        React.createElement(tslib_es6.Col, { md: 4, xs: 12 },
            React.createElement(tslib_es6.FormGroup, { className: "mb-3" },
                React.createElement(tslib_es6.FormLabel, null,
                    "Celular uno ",
                    React.createElement("span", { className: "text-danger" }, "*")),
                React.createElement(tslib_es6.FormControl, { minLength: 10, maxLength: 10, placeholder: "Ej: 300 200 2000", required: true }))),
        React.createElement(tslib_es6.Col, { md: 4, xs: 12 },
            React.createElement(tslib_es6.FormGroup, { className: "mb-3" },
                React.createElement(tslib_es6.FormLabel, null, "Celular dos "),
                React.createElement(tslib_es6.FormControl, { minLength: 10, maxLength: 10, placeholder: "Ej: 300 200 2000" }))),
        React.createElement(tslib_es6.Col, { md: 4, xs: 12 },
            React.createElement(tslib_es6.FormGroup, { className: "mb-3" },
                React.createElement(tslib_es6.FormLabel, null, "Tel\u00E9fono (o celular tres)"),
                React.createElement(tslib_es6.FormControl, { minLength: 10, maxLength: 10, placeholder: "Ej: 600 700 7000" }))),
        React.createElement(tslib_es6.Col, { xl: 6, md: 9, xs: 12 },
            React.createElement(tslib_es6.FormGroup, { className: "mb-3" },
                React.createElement(tslib_es6.FormLabel, null,
                    "Correo electr\u00F3nico ",
                    React.createElement("span", { className: "text-danger" }, "*")),
                React.createElement(tslib_es6.FormControl, { type: "email", maxLength: 100, required: true })))));
};

var NombrePersona = function () {
    return (React.createElement(tslib_es6.Row, null,
        React.createElement(tslib_es6.Col, { lg: 3, md: 6, xs: 12 },
            React.createElement(tslib_es6.FormGroup, { className: "mb-3" },
                React.createElement(tslib_es6.FormLabel, null,
                    "Primer nombre ",
                    React.createElement("span", { className: "text-danger" }, "*")),
                React.createElement(tslib_es6.FormControl, { type: "text", maxLength: 20, required: true }))),
        React.createElement(tslib_es6.Col, { lg: 3, md: 6, xs: 12 },
            React.createElement(tslib_es6.FormGroup, { className: "mb-3" },
                React.createElement(tslib_es6.FormLabel, null, "Segundo nombre"),
                React.createElement(tslib_es6.FormControl, { type: "text", maxLength: 50 }))),
        React.createElement(tslib_es6.Col, { lg: 3, md: 6, xs: 12 },
            React.createElement(tslib_es6.FormGroup, { className: "mb-3" },
                React.createElement(tslib_es6.FormLabel, null,
                    "Primer apellido ",
                    React.createElement("span", { className: "text-danger" }, "*")),
                React.createElement(tslib_es6.FormControl, { type: "text", maxLength: 50, required: true }))),
        React.createElement(tslib_es6.Col, { lg: 3, md: 6, xs: 12 },
            React.createElement(tslib_es6.FormGroup, { className: "mb-3" },
                React.createElement(tslib_es6.FormLabel, null, "Segundo apellido"),
                React.createElement(tslib_es6.FormControl, { type: "text", maxLength: 50 })))));
};
...
var Nuip = function (_a) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(tslib_es6.Row, null,
            React.createElement(tslib_es6.Col, { md: 4, xs: 12 },
                React.createElement(tslib_es6.FormGroup, { className: "mb-3" },
                    React.createElement(tslib_es6.FormLabel, null,
            ...
            React.createElement(tslib_es6.Col, { md: 4, xs: 12 },
                React.createElement(tslib_es6.FormGroup, { className: "mb-3" },
                    React.createElement(tslib_es6.FormLabel, null,
                        ...
                        React.createElement("span", { className: "text-danger" }, "*")),
                    React.createElement(tslib_es6.FormControl, { type: "text", minLength: 6, maxLength: 15, required: true }))),
            React.createElement(tslib_es6.Col, { md: 4, xs: 12 },
                React.createElement(tslib_es6.FormGroup, { className: "mb-3" },
                    React.createElement(tslib_es6.FormLabel, null,
                        "Fecha de expedici\u00F3n ",
                        React.createElement("span", { className: "text-danger" }, "*")),
                    React.createElement(tslib_es6.FormControl, { type: "date", max: new Date().toISOString().split("T")[0], required: true }))),
            React.createElement(tslib_es6.Col, { md: 8, xs: 12, style: { display: attach ? 'block' : 'none' } },
                React.createElement(tslib_es6.FormGroup, { controlId: "formFile", className: "mb-3" },
                    React.createElement(tslib_es6.FormLabel, null,
                        "Fotocopia del documento de identificaci\u00F3n personal ",
                        React.createElement("span", { className: "text-danger" }, "*")),
                    React.createElement(tslib_es6.FormControl, { type: "file", required: attach }))))));
};
...
var Pais = function (_a) {
    ...
    React.useEffect(function () {
        var obtenerPaises = function () { return tslib_es6.__awaiter(void 0, void 0, void 0, function () {
    ...
    return (React.createElement(tslib_es6.FormGroup, { className: "mb-3" },
        React.createElement(tslib_es6.FormLabel, null,
            "Pa\u00EDs ",
            React.createElement("span", { className: "text-danger" }, "*")),
...
var Departamento = function (_a) {
    ...
    React.useEffect(function () {
        var obtenerDepartamentos = function () { return tslib_es6.__awaiter(void 0, void 0, void 0, function () {
...
var Municipio = function (_a) {
    ...
    React.useEffect(function () {
        ...
        var obtenerMunicipio = function () { return tslib_es6.__awaiter(void 0, void 0, void 0, function () {
            var url, response, data, error_1;
            return tslib_es6.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
...
var Zona = function (_a) {
    ...
    React.useEffect(function () {
        var obtenerZonas = function () { return tslib_es6.__awaiter(void 0, void 0, void 0, function () {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(tslib_es6.Col, { md: 3, xs: 12, className: 'mb-3' },
            React.createElement(tslib_es6.FormLabel, null,
                "Zona ",
                React.createElement("span", { className: "text-danger" }, "*")),
...
var DireccionUrbana = function (_a) {
    ...
    return (React.createElement(tslib_es6.Row, null,
        React.createElement(tslib_es6.Col, { md: 3, xs: 12 },
            React.createElement(tslib_es6.FormGroup, { className: "mb-3" },
                React.createElement(tslib_es6.FormLabel, null,
                    "V\u00EDa principal ",
                    React.createElement("span", { className: "text-danger" }, "*")),
        ...
        React.createElement(tslib_es6.Col, { md: 2, xs: 12 },
            React.createElement(tslib_es6.FormGroup, { className: "mb-3" },
                React.createElement(tslib_es6.FormLabel, null,
                    "N\u00FAmero v\u00EDa ",
                    React.createElement("span", { className: "text-danger" }, "*")),
                React.createElement(tslib_es6.FormControl, { ref: numeroViaPrincipalRef, type: "text", value: numeroViaPrincipal, placeholder: 'Ej: 23', required: true }))),
        React.createElement(tslib_es6.Col, { md: 2, xs: 12 },
            React.createElement(tslib_es6.FormGroup, { className: "mb-3" },
                React.createElement(tslib_es6.FormLabel, null,
                    "Letra ",
                    React.createElement("span", { className: "text-danger" })),
                React.createElement(tslib_es6.FormControl, { type: "text", value: letraPrincipal, placeholder: 'Ej: A' }))),
        React.createElement(tslib_es6.Col, { md: 2, xs: 12, className: 'align-self-end' },
            React.createElement(tslib_es6.FormGroup, { className: 'mb-4' },
        ...
        React.createElement(tslib_es6.Col, { xs: 12, className: 'col-md-auto text-center align-self-center' },
        ...
        React.createElement(tslib_es6.Col, { md: 2, xs: 12 },
            React.createElement(tslib_es6.FormGroup, { className: "mb-3" },
                React.createElement(tslib_es6.FormLabel, null,
                    "N\u00FAmero uno ",
                    React.createElement("span", { className: "text-danger" }, "*")),
                React.createElement(tslib_es6.FormControl, { ref: numeroViaSecundariaRef, type: "text", placeholder: 'Ej: 13', required: true }))),
        React.createElement(tslib_es6.Col, { md: 2, xs: 12 },
            React.createElement(tslib_es6.FormGroup, { className: "mb-3" },
                React.createElement(tslib_es6.FormLabel, null,
                    "Letra ",
                    React.createElement("span", { className: "text-danger" })),
                React.createElement(tslib_es6.FormControl, { type: "text", value: letraSecundaria, placeholder: 'Ej: C' }))),
        React.createElement(tslib_es6.Col, { md: 2, xs: 12 },
            React.createElement(tslib_es6.FormGroup, { className: "mb-3" },
                React.createElement(tslib_es6.FormLabel, null,
                    "Cardinalidad ",
        ...
        React.createElement(tslib_es6.Col, { md: 2, xs: 12 },
            React.createElement(tslib_es6.FormGroup, { className: "mb-3" },
                React.createElement(tslib_es6.FormLabel, null,
                    "N\u00FAmero dos ",
                    React.createElement("span", { className: "text-danger" }, "*")),
                React.createElement(tslib_es6.FormControl, { ref: numeroPlacaRef, type: "text", value: numeroPlaca, placeholder: 'Ej: 25', required: true }))),
        React.createElement(tslib_es6.Col, { md: 3, xs: 12, style: { paddingRight: '7px' } },
            React.createElement(tslib_es6.FormGroup, { className: "mb-3" },
                React.createElement(tslib_es6.FormLabel, null,
                    "Complemento ",
                    React.createElement("span", { className: "text-danger" })),
                React.createElement(tslib_es6.FormControl, { type: "text", value: complemento, placeholder: 'Ej: Casa 3' }))),
        React.createElement(tslib_es6.Col, { md: 4, xs: 12 },
            React.createElement(tslib_es6.FormGroup, { className: "mb-3" },
                React.createElement(tslib_es6.FormLabel, null,
                    "Barrio / Sector ",
                    React.createElement("span", { className: "text-danger" }, "*")),
                React.createElement(tslib_es6.FormControl, { ref: nombreBarrioRef, type: "text", value: nombreBarrio, required: true }))),
        React.createElement(tslib_es6.Col, { md: 8, xs: 12 },
            React.createElement(tslib_es6.FormGroup, { className: "mb-2" },
                React.createElement(tslib_es6.FormLabel, null,
                    "Resumen de direcci\u00F3n ",
                    React.createElement("span", { className: "text-danger" }, "**")),
                React.createElement(tslib_es6.FormControl, { type: "text", className: 'bg-body-secondary', value: resumenDireccion, disabled: true }))),
        React.createElement(tslib_es6.Col, { md: 12, xs: 12 },
            React.createElement(tslib_es6.FormGroup, { className: "mb-2" },
                React.createElement(tslib_es6.FormLabel, null, "Indicaciones del lugar de domicilio"),
                React.createElement(tslib_es6.FormControl, { type: "text", value: indicacionDireccion })))));
};
        ...
        React.createElement(tslib_es6.Col, { md: 4, xs: 12 },
            React.createElement(tslib_es6.FormGroup, { className: "mb-3" },
                React.createElement(tslib_es6.FormLabel, null,
                    "Corregimiento ",
                    React.createElement("span", { className: "text-danger" })),
                React.createElement(tslib_es6.FormControl, { ref: corregimientoRef, type: "text", value: corregimiento, maxLength: 100 }))),
        React.createElement(tslib_es6.Col, { md: 4, xs: 12 },
            React.createElement(tslib_es6.FormGroup, { className: "mb-3" },
                React.createElement(tslib_es6.FormLabel, null,
                    "Vereda ",
                    React.createElement("span", { className: "text-danger" }, "*")),
                React.createElement(tslib_es6.FormControl, { ref: veredaRef, type: "text", value: vereda, maxLength: 100, required: true }))),
        React.createElement(tslib_es6.Col, { md: 4, xs: 12 },
            React.createElement(tslib_es6.FormGroup, { className: "mb-3" },
                React.createElement(tslib_es6.FormLabel, null,
                    "Centro poblado ",
                    React.createElement("span", { className: "text-danger" })),
                React.createElement(tslib_es6.FormControl, { ref: centroPobladoRef, type: "text", value: centroPoblado, maxLength: 100 }))),
        React.createElement(tslib_es6.Col, { md: 12, xs: 12 },
            React.createElement(tslib_es6.FormGroup, { className: "mb-2" },
                React.createElement(tslib_es6.FormLabel, null, "Indicaciones del lugar de domicilio"),
                React.createElement(tslib_es6.FormControl, { type: "text", value: indicacionDireccion })))));
...
var UbicacionPersona = function () {
    ...
    return (React.createElement(tslib_es6.Row, null,
        ...
        React.createElement(Collapse, { in: zona === '1' },
            React.createElement(tslib_es6.Container, { className: "pb-0 mb-0 bg-section" },
                React.createElement(tslib_es6.Card, { className: "border-light-subtle rounded-3" },
                    React.createElement(tslib_es6.CardBody, null,
                        React.createElement(tslib_es6.Row, { className: 'mb-1 mt-1' },
                            React.createElement(tslib_es6.Col, { className: "col-auto pe-1" },
                                React.createElement(tslib_es6.FaTreeCity, { style: iconStyle })),
            ...
            React.createElement(tslib_es6.Container, { className: "pb-0 mb-0 bg-section" },
                React.createElement(tslib_es6.Card, { className: "border-light-subtle rounded-3" },
                    React.createElement(tslib_es6.CardBody, null,
                        React.createElement(tslib_es6.Row, { className: 'mb-1 mt-1' },
                            React.createElement(tslib_es6.Col, { className: "col-auto pe-1" },
                                React.createElement(tslib_es6.FaTree, { style: iconStyle })),
                            React.createElement(tslib_es6.Col, { className: "ps-1 col-auto align-self-center" },
...
//# sourceMappingURL=UbicacionPersona-D9vVFakH.js.map
