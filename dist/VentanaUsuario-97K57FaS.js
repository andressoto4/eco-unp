...
import { _ as _objectWithoutPropertiesLoose$7, j as jsxRuntimeExports, e as triggerBrowserReflow, T as TransitionWrapper, t as transitionEndListener, c as classNames, b as ENTERING, d as ENTERED, u as useBootstrapPrefix, f as FormCheckInput, r as useMergedRefs, v as context$2, P as PropTypes, w as map, x as forEach, m as Container, R as Row, C as Col, n as Card, y as CardHeader, z as CardTitle, o as CardBody, A as requireReactIs, B as getDefaultExportFromCjs, G as GenIcon, i as FormGroup, k as FormLabel, l as FormControl, D as FaUnlockKeyhole, H as FaXTwitter, I as FaInstagram, J as FaFacebook, K as FaYoutube, L as FaHeadphones, M as FaPhoneFlip, N as FaFileContract, O as FaKey } from './index-BGgWzTHb.js';
...
const InicioSesionHook = (maxAttempts, blockTime) => {
    ...
    const handleSubmit = async (e, usuarioRef, contrasegnaRef, recaptchaRef) => {
        ...
        if (attempts < maxAttempts) {
            ...
            if (!recaptchaToken) {
                e.stopPropagation();
                B.error("Por favor, completa el reCAPTCHA", {
                    position: "top-right",
                    className: "foo-bar",
                    hideProgressBar: true,
                });
            ...
            if (username && password) {
                try {
                    await B.promise(InicioSesionRequest(username, password, recaptchaToken), {
                        pending: "Ingresando...",
                        success: {
                            render({ data }) {
                ...
                B.error("Usuario o contraseña no pueden estar vacíos", {
                    position: "top-right",
                    className: "foo-bar",
                    hideProgressBar: true,
                });
...
function validarTextoMayusculasYNumeros(input) {
    const patron = /^[A-Z]+[0-9]+$/;
    return patron.test(input);
}
function validarTextoPuntoTexto(input) {
        ...
        React__default.createElement(Col, { xl: 12, md: 12, xs: 12 },
            React__default.createElement(FormGroup, { className: "mb-3", controlId: "validacionUsuario" },
                ...
                React__default.createElement(InputGroup$1, null,
                    ...
                    React__default.createElement(FormControl, { className: "rounded-end", type: "text", ref: usuarioRef, value: usuario, onChange: handleUsuarioChange, onInput: handleUsuarioChange, placeholder: "nombre.apellido", 
                        // pattern={pattern}
            ...
            React__default.createElement(FormGroup, { className: "mb-3", controlId: "validacionContrasegna" },
                ...
                React__default.createElement(InputGroup$1, null,
                    React__default.createElement(InputGroup$1.Text, { id: "password-icon" },
                        React__default.createElement(FaUnlockKeyhole, null)),
...
const Login = (props) => {
    ...
    React__default.createElement("div", { className: "login-container" },
        React__default.createElement(Container, { style: { maxWidth: "720px", maxHeight: "600px" } },
            React__default.createElement(Row, { className: "justify-content-md-center border-0 rounded shadow" },
                React__default.createElement(Col, { md: 6, className: "bg-form align-content-center px-5 rounded-start" },
                    React__default.createElement(Row, { className: "justify-content-md-center" },
                        ...
                        React__default.createElement("p", { className: "text-center mt-4", style: { color: "#BFBFBF", fontWeight: "500" } }, "Integrar la gesti\u00F3n, potencializar los resultados"))),
            ...
            React__default.createElement(Row, { className: "mt-2 d-flex justify-content-beetween" },
                ...
                React__default.createElement(Col, { className: "me-0 d-flex justify-content-end align-items-center" },
                    React__default.createElement(RedesSociales, { IconoRedSocial: FaFileContract, color: "#365072", descripcion: "Pol\u00EDticas de datos", enlace: "https://www.unp.gov.co/normativa/politicas-de-seguridad-de-la-informacion-y-proteccion-de-datos-personales/" }),
                    React__default.createElement(RedesSociales, { IconoRedSocial: FaKey, color: "#365072", descripcion: "Recuperar contrase\u00F1a", enlace: "#" })))),
...
const IniciarSesion = () => {
    ...
    // -----> Renderizado
    return (React__default.createElement(React__default.Fragment, null, isAuthenticated ? (
...
//# sourceMappingURL=VentanaUsuario-97K57FaS.js.map
