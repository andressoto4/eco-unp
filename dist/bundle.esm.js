...
var VentanaUsuario = function (_a) {
    var children = _a.children;
    var _b = React__default.useState(false), menuOpen = _b[0], setMenuOpen = _b[1];
    var _c = React__default.useState(null), key = _c[0], setKey = _c[1];
    var handleToggle = function () {
        setMenuOpen(!menuOpen);
    };
    ...
    return (React__default.createElement(React__default.Fragment, null,
        ...
        React__default.createElement("div", { className: "".concat(menuOpen ? 'menu-open' : '') },
            React__default.createElement("div", { className: "main-section" },
                React__default.createElement(Tabs, { id: "controlled-tab-example", activeKey: key, onSelect: function (k) { return setKey(k); } }, React__default.Children.map(children, function (child) {
