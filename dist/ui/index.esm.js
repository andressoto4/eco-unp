...
var SubtituloForm = function (_a) {
    var titulo = _a.titulo, Icon = _a.icon;
    return (React__default.createElement(Row, { className: 'mb-1 mt-3' },
        ...
        React__default.createElement(Col, { className: "ps-1 col-auto align-self-center" },
            React__default.createElement("p", { style: subtituloStyle }, titulo))));
};
...
export { SubtituloForm, TabVentana, VentanaLienzo, VentanaUsuario };
