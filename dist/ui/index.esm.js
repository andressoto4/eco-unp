...
import React__default, { useRef, useState, useCallback, useContext, useMemo, useEffect, useReducer, cloneElement } from 'react';
...
function useUncontrolled(props, config) {
  return Object.keys(config).reduce(function (result, fieldName) {
    ...
    var _ref = result,
        ...
        rest = _objectWithoutPropertiesLoose$6(_ref, [defaultKey(fieldName), fieldName].map(_toPropertyKey$1));
...
var divWithClassName = (className => /*#__PURE__*/React.forwardRef((p, ref) => /*#__PURE__*/jsxRuntimeExports.jsx("div", {
  ...p,
  ref: ref,
...
function useTabPanel(_ref) {
  ...
  const {
    ...
    rest = _objectWithoutPropertiesLoose$1(context, _excluded2);
...
(_ref2, ref) => {
  let {
    ...
    props = _objectWithoutPropertiesLoose$1(_ref2, _excluded3);
  const [tabPanelProps, {
    isActive,
    onEnter,
    onEntering,
    ...
    return (React__default.createElement(Container, { className: "py-5" },
        React__default.createElement(Row, { className: "justify-content-center" },
            React__default.createElement(Col, { xl: 10, md: 11, xs: 12 },
                React__default.createElement(Card$1, { style: borderUnpStyle, className: "border-0 rounded-3 shadow" },
    ...
    return (React__default.createElement("div", { className: "container-fluid ".concat(isOpen ? "menu-open" : "") },
        React__default.createElement("div", { className: sidebarClass },
            React__default.createElement("div", { className: "logo_details" },
                React__default.createElement("img", { src: "../../../public/logo-unp.png", alt: "Logo", className: "icon logo-image" }),
...
export { CardForm, SubtituloForm, TabVentana, VentanaLienzo, VentanaUsuario };
