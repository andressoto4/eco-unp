import React, { useState, useContext, ChangeEvent, useEffect, RefObject } from 'react';
...
const Ubicacion: React.FC<UbicacionProps> = ({ paisDomicilioRef, departamentoDomicilioRef, municipioDomicilioRef }) => {
    ...
    return (
        <React.Fragment>
            <Col lg={3} md={6} xs={12}>
                <Pais paisRef={paisDomicilioRef} idPaisUbicacion={Number(idPaisUbicacion)} onChange={handlePaisChange} />
            </Col>
            <Col lg={3} md={6} xs={12}>
                <Departamento departamentoRef={departamentoDomicilioRef} idPais={Number(idPaisUbicacion)} onChange={handleDepartamentoChange} />
            </Col>
            <Col lg={3} md={6} xs={12}>
                <Municipio municipioRef={municipioDomicilioRef} idDepartamento={Number(idDepartamentoUbicacion)} onChange={handleMunicipioGet} />
            </Col>
        </React.Fragment>
    );
};
    ...
    return (
        <React.Fragment>
            <Col md={3} xs={12} className='mb-3'>
                <FormLabel>Zona <span className="text-danger">*</span></FormLabel>
                <FormSelect ref={zonaDomicilioRef} value={zonaSeleccionada} onChange={handleZonaChange} required>
...
const DireccionUrbana: React.FC<DireccionUrbanaProps> = ({ contentType, viaPrincipalRef, numeroViaPrincipalRef, numeroViaSecundariaRef, numeroPlacaRef, nombreBarrioRef }) => {
        ...
        <Row>
            ...
            <Col md={3} xs={12}>
                <FormGroup className="mb-3">
                    <FormLabel>Vía principal <span className="text-danger">*</span></FormLabel>
                    <FormSelect ref={viaPrincipalRef} value={viaPrincipal} onChange={(e) => setViaPrincipal(e.target.value)} required>
            ...
            <Col md={2} xs={12}>
                <FormGroup className="mb-3">
                    <FormLabel>Número vía <span className="text-danger">*</span></FormLabel>
                    <FormControl
            ...
            <Col md={2} xs={12}>
                <FormGroup className="mb-3">
                    <FormLabel>Letra <span className="text-danger"></span></FormLabel>
                    <FormControl
                        type="text"
            ...
            <Col md={3} xs={12}>
                <FormGroup className="mb-3">
                    <FormLabel>Cardinalidad <span className="text-danger"></span></FormLabel>
                    <FormSelect value={cuadrantePrincipal} onChange={(e) => setCuadrantePrincipal(e.target.value)}>
            ...
            <Col md={2} xs={12}>
                <FormGroup className="mb-3">
                    <FormLabel>Número uno <span className="text-danger">*</span></FormLabel>
                    <FormControl
            ...
            <Col md={2} xs={12}>
                <FormGroup className="mb-3">
                    <FormLabel>Cardinalidad <span className="text-danger"></span></FormLabel>
                    <FormSelect value={cuadranteSecundario} onChange={(e) => setCuadranteSecundario(e.target.value)}>
                        <option value="">Seleccione la cardinalidad</option>
                        <option value="Norte">Norte</option>
                        <option value="Sur">Sur</option>
                        <option value="Este">Este</option>
            ...
            <Col md={2} xs={12}>
                <FormGroup className="mb-3">
                    <FormLabel>Número dos <span className="text-danger">*</span></FormLabel>
                    <FormControl
                        ref={numeroPlacaRef}
                        type="text"
                        value={numeroPlaca}
            ...
            <Col md={3} xs={12} style={{ paddingRight: '7px' }}>
                <FormGroup className="mb-3">
                    <FormLabel>Complemento <span className="text-danger"></span></FormLabel>
                    <FormControl
                        type="text"
                        value={complemento}
            ...
            <Col md={4} xs={12}>
                <FormGroup className="mb-3">
                    <FormLabel>Barrio / Sector <span className="text-danger">*</span></FormLabel>
                    <FormControl ref={nombreBarrioRef} type="text" value={nombreBarrio} required />
                </FormGroup>
            </Col>

            <Col md={8} xs={12}>
                <FormGroup className="mb-2">
                    <FormLabel>Resumen de dirección <span className="text-danger">**</span></FormLabel>
...
const DireccionRural: React.FC<DireccionRuralProps> = ({ contentType, corregimientoRef, veredaRef, centroPobladoRef }) => {
    ...
    const handleTextChange = (event: ChangeEvent<HTMLInputElement>, setter: React.Dispatch<React.SetStateAction<string>>) => {
        setter(event.target.value);
    };

    const handleAreaChange = (event: ChangeEvent<HTMLInputElement>, setter: React.Dispatch<React.SetStateAction<string>>) => {
        setter(event.target.value);
    };
    ...
    return (
        ...
        <Row>
            <Col md={4} xs={12}>
                <FormGroup className="mb-3">
                    <FormLabel>Corregimiento <span className="text-danger"></span></FormLabel>
                    <FormControl
            ...
            <Col md={4} xs={12}>
                <FormGroup className="mb-3">
                    <FormLabel>Vereda <span className="text-danger">*</span></FormLabel>
                    <FormControl
                        ref={veredaRef}
                        type="text"
                        value={vereda}
            ...
            <Col md={4} xs={12}>
                <FormGroup className="mb-3">
                    <FormLabel>Centro poblado <span className="text-danger"></span></FormLabel>
                    <FormControl
...
const UbicacionPersona = () => {
    ...
    const handleZonaChange = (e: { target: { value: React.SetStateAction<string>; }; }) => {
