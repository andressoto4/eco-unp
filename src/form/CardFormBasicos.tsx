...
import { FaAddressCard, FaLocationDot, FaMarsAndVenus, FaPen, FaPhone, FaUser } from "react-icons/fa6";
import { CardForm, Encabezado, SubtituloForm } from "../ui";
...
const CardFormBasicos: React.FC<CardFormBasicosProps> = ({ method, canEdit = false, hasHeader = false, dependencia = 'Ecosistema de Información' }) => {
    ...
    return (
        <>
            ...
            <CardForm method={methodBasicos} changeMethod={setMethodBasicos} titulo="Datos básicos de la persona" canEdit={canEdit} hasBody={false}>
                <CardBody>
                    <SubtituloForm subtitulo={'Nombre(s) y Apellido(s)'} icon={FaUser} />
                    <NombrePersona method={methodBasicos} />
                </CardBody>
                <CardBody style={cardBodyStyle}>
                    <SubtituloForm subtitulo={'Número único de identificación personal'} icon={FaAddressCard} />
                    <Nuip method={methodBasicos} />
                </CardBody>
                <CardBody>
                    <SubtituloForm subtitulo={'Género y orientación sexual'} icon={FaMarsAndVenus} />
