...
var Departamento = function (_a) {
    var idPais = _a.idPais, onChange = _a.onChange, departamentoRef = _a.departamentoRef, method = _a.method;
        ...
        var obtenerDepartamentos = function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                        url = "http://localhost:8000/sistema/departamento/?pais=".concat(idPais);
    ...
    return (React.createElement(FormGroup, { className: "mb-3" },
        ...
        method === 'GET' ?
            React.createElement(FormControl, { type: "text", disabled: true })
            :
